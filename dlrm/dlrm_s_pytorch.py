...
class DLRM_Net(nn.Module):
    ...
    def apply_emb(self, lS_o, lS_i, emb_l):
        ...
        for k, sparse_index_group_batch in enumerate(lS_i):
            ...
            pooling_start = time.process_time()
            ...
            total_pooling_time += (time.process_time() - pooling_start)

            append_start = time.process_time()

            ly.append(V)

            total_append_time += (time.process_time()-append_start)

        print("total_pooling_time: ", total_pooling_time)
        print("total_append_time: ", total_append_time)


        return_time_begin = time.process_time()
        print("return_time_begin", return_time_begin)
    ...
    def sequential_forward(self, dense_x, lS_o, lS_i):
        ...
        print("return time: ", time.process_time()-return_time_begin)
