// To build the code: dpu-upmem-dpurte-clang -o toy_dpu_10MB toy_dpu_10MB.c
#include <mram.h>
#include <stdbool.h>
#include <stdint.h>
#include <stdio.h>

__mram_noinit int32_t data[10485760];
...
int main() { 
    __dma_aligned int32_t read_buf[10485760];
    ...
    mram_write((const int32_t*)read_buf, DPU_MRAM_HEAP_POINTER, 10485760*sizeof(int32_t));
