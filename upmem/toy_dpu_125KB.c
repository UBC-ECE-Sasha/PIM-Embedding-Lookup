// To build the code: dpu-upmem-dpurte-clang -o toy_dpu_125KB toy_dpu_125KB.c
#include <mram.h>
#include <stdbool.h>
#include <stdint.h>
#include <stdio.h>

__mram_noinit int32_t data[131072];
...
int main() { 
    __dma_aligned int32_t read_buf[131072];
    ...
    mram_write((const int32_t*)read_buf, DPU_MRAM_HEAP_POINTER, 131072*sizeof(int32_t));
